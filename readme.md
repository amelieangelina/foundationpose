...
You can execute into the contianer like this
```
docker exec -it foundationpose bash
```

If it's the first time you launch the container, you need to build extensions inside the container.
```
bash build_all.sh
```
